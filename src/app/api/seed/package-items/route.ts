...
const ESSENCIAL: Array<{ category: string; description: string; quantity: number; unitCost: number; order: number }> = [
  ...
  { category: "Elétrica", description: "Chuveiro",           quantity: 1, unitCost:  100, order: 1030 },
  { category: "Elétrica", description: "Materiais",          quantity: 1, unitCost:  300, order: 1040 },
  // PINTURA
  ...
  // ACABAMENTOS
  { category: "Acabamentos", description: "Piso Laminado Casal",       quantity: 1, unitCost:  850, order: 3010 },
  { category: "Acabamentos", description: "Piso Laminado Solteiro",    quantity: 1, unitCost:  600, order: 3020 },
  { category: "Acabamentos", description: "Box de Vidro",              quantity: 1, unitCost:  800, order: 3030 },
  { category: "Acabamentos", description: "Suportes Banheiro",         quantity: 1, unitCost:  100, order: 3035 },
  ...
  { category: "Móveis", description: "Roupeiro Casal",        quantity: 1, unitCost: 1900, order: 5030 },
  { category: "Móveis", description: "Roupeiro Solteiro",     quantity: 1, unitCost: 1900, order: 5040 },
